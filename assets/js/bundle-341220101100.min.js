...
function bs(t, a, i, n) {
    var e = function(t, a) {
            document.cookie = t + "= " + a + ";path=/"
        },
        g = function(g) {
            var r = g || r;
            e(t, r.level), e(a, r.charging ? 1 : 0), r.chargingTime !== 1 / 0 && e(i, r.chargingTime), r.dischargingTime !== 1 / 0 && e(n, r.dischargingTime)
        };
    navigator.battery ? g(navigator.battery) : navigator.getBattery && navigator.getBattery().then(g)
};
"use strict";
! function() {
    var n = {
        ...
        o = function(n, o) {
            window.dispatchEvent(new CustomEvent("dtchange", {
                detail: {
                    open: n,
                    orientation: o
                }
    ...
    setInterval((function() {
        ...
        i && e || !(window.Firebug && window.Firebug.chrome && window.Firebug.chrome.isInitialized || e || i) ? (n.open && o(!1, null), n.open = !1, n.orientation = null) : (n.open && n.orientation === t || o(!0, t), n.open = !0, n.orientation = t)
    }), 500), "undefined" != typeof module && module.exports ? module.exports = n : window.devtools = n
}();;
"use strict";
...
var fp = function(e) {
    ...
    function b(e) {
        return e = h(e, [0, e[0] >>> 1]), e = h(e = m(e, [4283543511, 3981806797]), [0, e[0] >>> 1]), h(e = m(e, [3301882366, 444984403]), [0, e[0] >>> 1])
    }
    ...
    function V(e) {
        return e && "object" == _typeof(e) && "message" in e ? e : {
            message: e
        }
    }
                ...
                switch (r.label) {
                    ...
                    case 4:
                        return r.trys.push([4, , 10, 11]), [4, new Promise((function(e, r) {
                            ...
                            ! function e() {
                                var n, t;
                                o || ("complete" === (null === (t = null === (n = l.contentWindow) || void 0 === n ? void 0 : n.document) || void 0 === t ? void 0 : t.readyState) ? a() : setTimeout(e, 10))
                            }()
                        }))];
                    case 5:
                        r.sent(), r.label = 6;
    ...
    var J, H, N = ["monospace", "sans-serif", "serif"],
    ...
    function D() {
        ...
        return function() {
                if (void 0 === H) {
                    ! function e() {
                        var n = E();
                        T(n) ? H = setTimeout(e, 2500) : (J = n, H = void 0)
                    }()
                }
            }(),
            function() {
                return t(e, void 0, void 0, (function() {
                    ...
                    return r(this, (function(n) {
                        switch (n.label) {
                            case 0:
                                return T(e = E()) ? J ? [2, o([], J, !0)] : R() ? [4, (t = document, (t.exitFullscreen || t.msExitFullscreen || t.mozCancelFullScreen || t.webkitExitFullscreen).call(t))] : [3, 2] : [3, 2];
                            case 1:
    ...
    function B(e) {
        ...
        return t(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                    case 0:
                        for (t = document, o = t.createElement("div"), a = new Array(e.length), c = {}, _(o), s = 0; s < e.length; ++s) u = A(e[s]), _(l = t.createElement("div")), l.appendChild(u), o.appendChild(l), a[s] = u;
                        r.label = 1;
                    case 1:
    ...
    var $ = Math,
        ...
        te = {
                    ...
                    var o = t.createElement("div"),
                        ...
                        l = function() {
                            for (var e = {}, n = function(n) {
                                    e[n] = N.map((function(e) {
                                        return function(e, n) {
                                            return c("'".concat(e, "',").concat(n))
                                        }(n, e)
                                    }))
                                }, t = 0, r = P; t < r.length; t++) n(r[t]);
                            return e
                        }();
                    r.appendChild(o);
                    for (var s = 0; s < N.length; s++) a[N[s]] = u[s].offsetWidth, i[N[s]] = u[s].offsetHeight;
                    return P.filter((function(e) {
                        return n = l[e], N.some((function(e, t) {
            ...
            fontPreferences: function() {
                return void 0 === e && (e = 4e3), j((function(n, t) {
                    var r = t.document,
                        a = r.body,
                        i = a.style;
                    i.width = "".concat(e, "px"), i.webkitTextSizeAdjust = i.textSizeAdjust = "none", F() ? a.style.zoom = "".concat(1 / t.devicePixelRatio) : C() && (a.style.zoom = "reset");
                    ...
                    return c.textContent = o([], Array(e / 20 << 0), !0).map((function() {
                        ...
                        function(e, n) {
                            ...
                            for (var p = 0, y = Object.keys(ne); p < y.length; p++) r[i = y[p]] = t[i].getBoundingClientRect().width;
                            return r
                        }(r, a)
                            ...
                            t = new Promise((function(t, r) {
                                ...
                                (function n() {
                                    try {
                                        ...
                                        switch (c(t) && s(t), e.state) {
                                            case "running":
                                                i = Date.now(), o && u();
                                                break;
                                            case "suspended":
                                                document.hidden || a++, o && a >= 3 ? r(M("suspended")) : setTimeout(n, 500)
                                        }
                                    } catch (e) {
                                        r(e)
                                    }
            ...
            canvas: function() {
                ...
                if (function(e, n) {
                    ...
                    var i = z(o);
                    i !== z(o) ? e = n = "unstable" : (n = i, function(e, n) {
...
function pm(e, t) {
    var n = function() {
        document.cookie = e + "=1;path=/; expires=" + new Date((new Date).getTime() + 1e3 * t).toUTCString()
    };
    switch (!0) {
        case !!(/(?=.*(opera|chrome|yabrowser)).*/i.test(navigator.userAgent) && navigator.storage && navigator.storage.estimate):
            navigator.storage.estimate().then((function(e) {
                e.quota < 12e7 && n()
            }));
            break;
        case "MozAppearance" in document.documentElement.style:
            indexedDB.open("test").onerror = n;
            break;
        case null !== navigator.userAgent.match(/Version\/([0-9\._]+).*Safari/):
            try {
                localStorage.test = 1, window.openDatabase(null, null, null, null)
            } catch (e) {
                n()
            }
            break;
        case !window.indexedDB && (window.PointerEvent || window.MSPointerEvent):
            n()
    }
}